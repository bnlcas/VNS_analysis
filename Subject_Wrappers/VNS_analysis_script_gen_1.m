...
%% Find bad channels:
VNS_raw = VNS_process_raw(dat_dir, ekg_chan ,ecog_elecs, [],'load_full_dir', 1:25, 'load_RAW_erps',true,'load_env',false,'load_full_dir',false,'notch_data',false,'VNS_duty_cycle', duty_cycle);
...
%% Heart Rate:
VNS_dat_hr = VNS_process_raw(dat_dir, ekg_chan, 1, [],'load_env', false,  'load_heart_rate', true, 'notch_data', false);
analyze_heartRate(VNS_dat_hr)
HRV_trend_measure(VNS_dat_hr)